    ...
    while (turn != 18):
        ...
        if turn % 3 == 0:
            ...
            for group in forceOptimizer.groups:
                ...
                ne_x_pos = group.size_width - 1
                for blk in blocks_NE:
                    blk.pos = [ne_x_pos, blk.pos[1]]
                    ne_x_pos -= 1
                ...
                # place N blocks left to right starting at last NW position
                for blk in blocks_N:
                    blk.pos = [nw_x_pos, blk.pos[1]]
                    nw_x_pos += 1
